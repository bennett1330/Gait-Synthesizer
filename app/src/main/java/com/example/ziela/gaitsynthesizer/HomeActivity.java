...
/**
 * This is the activity for the home page. Basically the only thing this class cares about is when
 * to transition to the next activity. We can alter how this home page looks in the XML file
 * labelled activity_home.xml
 */
